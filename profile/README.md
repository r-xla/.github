...
The end-user facing package is [anvl](https://github.com/r-xla/anvl).
...
| [**docker**](https://github.com/r-xla/docker) | Daily Docker images (CPU + CUDA) with anvl pre-installed |
